<script lang="ts">
  ...
  function update() {
    ...
    if (computerPaddle.y > 600 - paddleHeight) computerPaddle.y = 600 - paddleHeight;
        ...
        <div class="space-y-4">
          ...
          <div>
            ...
            <ul class="list-disc list-inside space-y-1 text-sm">
              <li>Use <kbd class="kbd kbd-sm">↑</kbd> and <kbd class="kbd kbd-sm">↓</kbd> arrow keys to move your paddle</li>
